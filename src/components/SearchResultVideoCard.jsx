...
const SearchResultVideoCard = ({video}) => {
  return (
 <Link to={`/video/${video?.video}`}>
  <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
     <div className="relative flex shrink-0 h-48 md:h-28 lg:h-40 xl:h-48 w-full md:w-48 ld:w-64 xl:w-80 rounded">
      ...
      <span className='empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-white/[0.7] md:pr-24 md:my-4'>
       ...
       <div className="hidden md:flex items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex item-sm font-semibold text-white/[0.7] truncate overflow-hidden">
               <span>{ `${abbreviateNumber(
                video?.stats?.views,
                2
               )}views`}</span>
               <span className='flex text-[24px] leading-none font-bold text-white/[0.7] relative top-[-10px] -mx-11'>
                .
               </span>
